...
$DEFAULT_CLUSTERS = [
    "ace" => [0 => 0, 1 => 1, 4 => 4, 5 => 5],
    "ca" => [0 => 0, 2 => 2, 3 => 3],
    "neuraminidase" => [0 => 0, 4 => 4, 7 => 7],
    "phospholipase" => [0 => 0, 2 => 2, 5 => 5, 6 => 6],
    "urokinase" => [0 => 0, 1 => 1, 3 => 3]
];

$pse = "examples/$example/$example"."_pse.b64";
$example_dir = "/home/ftmap/public_html/examples/".$example;
    ...
    var info = {
        background: '#000000',
            ...
            readyFunction: function() {
                ...
                $("#jsmol_control").show();
                <?php
                # $unselect = array_diff_key($clusters, $DEFAULT_CLUSTERS[$example]);
                # foreach ($unselect as $i => $_)
                # {
                #     echo sprintf("$('#cc%s').trigger('click');\n", $i);
                # }
                ?>
            }
    };
