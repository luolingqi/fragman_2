...
$(document).ready(function() {
  $('input').val(['cc0','cc1','cc2','cc6','lig1']);
  $('label[for="cc0"], label[for="cc1"], label[for="cc2"], label[for="cc6"], label[for="lig1"]').addClass('ui-state-active').attr('aria-pressed', true);
});
//-->
</script>
<style>
...
<div class="main">
<h2 style="margin-top:0;padding-top:16px;">Carbonic Anhydrase I</h2>
<p>Mapping of unbound <a href="http://www.pdb.org/pdb/explore/explore.do?structureId=2cab">PDB 2cab</a> with <a href="http://en.wikipedia.org/wiki/Dorzolamide">Dorzolamide</a> from <a href="http://www.pdb.org/pdb/explore/explore.do?structureId=1cil">PDB 1cil</a> superimposed.</p>
<div id="applet_container" style="width:632px;float:left;padding-left:16px;">
	<applet width="600" height="600" id="av" name="av" code="MoleculeViewerApplet.class" archive="examples/MoleculeViewer.jar" style="padding-bottom:16px;">
		<param name="scriptFile" value="examples/ca.script">
		<img src="examples/Carbonic_Anhydrase.png" />
...
?>
<input type='checkbox' id='lig1' value='lig1'><label for='lig1'>Dorzolamide</label><br>
