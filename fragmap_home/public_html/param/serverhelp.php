...
the <a href="examples.php">Examples Page</a> or use a protein of your own.</p>
...
<img src="image/param_home_crop.png" alt="Home Page" />
...
<li><i>Upload PDB</i>: Select <i>Browse</i> to upload a file containing a structure in PDB format or click <i>Use PDB ID</i>.</li></ul><br></li>
...
<li><i>Probes</i>: Choose the <i>Original</i> probe set or choose to <a href="#upload"><i>Upload Small Molecules</i></a> of your own in addiction to original 
sixteen probes.</li><br>
...
<br><br>
<a name="upload"><h4>Upload Small Molecules</h4></a>
<p>Use this dialog box to upload additional small molecules to serve as probes. Uploaded small molecules must be submitted as SMILES strings. 
Learn more about <a href="http://www.daylight.com/dayhtml/doc/theory/theory.smiles.html">SMILES</a>.</p>
<img src="image/param_upload_crop.png" />
<p>If you have selected the option to <i>Upload Small Molecules</i> of your own, you will see this dialog box appear. To enter your small molecule, you must enter 
the formal charge of your desired molecule, followed by a space, and then the SMILES string representation of your molecule (as demonstrated in the example 
just above the dialog box). Multiple small molecules can be uploaded simultaneously by putting each molecule on its own line in the dialog box, up to 10 molecules.</p>
<p>Molecules that are too large will generate too many conformers and will not be run. We recommend molecules with 3 or fewer rotatable bonds to be submitted.</p>
<p>Your uploaded small molecules will be run along side the sixteen original probes in the default probe set. At the end of the FTMap run, these sixteen default probes 
alone will be clustered. All uploaded small molecules that overlap with one of these predicted clusters will be returned with the results.</p>
<br><br><p><small><a href="#contents">Return to Top</a></small></p>
...
<img src="image/param_status_crop.png" alt="Status Page" />
...
<li><i>Probe Status</i>: Status for each small molecule probe. See the <a href="#probe_status_abbr">Probe Status Abbreviation</a> table. 
Your uploaded probes will be listed here along with the 16 original probes. They will have been assigned generated names where the first two 
digits represent the order they were uploaded and the second two digits represent the particular conformation.</li></ul></p>
<br><br><p><small><a href="#contents">Return to Top</a></small></p>
...
<img src="image/param_results_detail_crop.png" alt="Results Detail" />
...
<img src="image/param_visualization_crop.png" alt="Visualization" />
...
<img src="image/param_graphs_crop.png" alt="Contact Graphs" />
...
<img src="image/param_papers_crop.png" alt="Publications Page" />
<br><br><p><small><a href="#contents">Return to Top</a></small></p>
