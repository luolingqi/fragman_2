...
*/
	...
	if (yc == 0)
		...
		w1 = -acos(-xc / sqrt(xc * xc + yc * yc)) + 3.1415926;
	else if (xc <= 0 && yc <= 0)
		w1 = acos(-xc / sqrt(xc * xc + yc * yc)) - 3.1415926;
	else if (xc >= 0 && yc <= 0)
		w1 = -acos(xc / sqrt(xc * xc + yc * yc));
	...
	if (zc3 >= 0 && xc3 >= 0)
		...
		w2 = -acos(-xc3 / sqrt(xc3 * xc3 + zc3 * zc3)) + 3.1415926;
	else if (zc3 >= 0 && xc3 <= 0)
		w2 = acos(-xc3 / sqrt(xc3 * xc3 + zc3 * zc3)) - 3.1415926;
	...
	if (ya4 >= 0 && za4 <= 0)
		...
		w3 = -acos(-ya4 / sqrt(ya4 * ya4 + za4 * za4)) + 3.1415926;
	else if (ya4 <= 0 && za4 <= 0)
		w3 = acos(-ya4 / sqrt(ya4 * ya4 + za4 * za4)) - 3.1415926;
	...
	if (xc5 > 0) {
		...
		if (ya5 > 0 && yd5 > 0 || ya5 < 0 && yd5 < 0) {
			...
			if (zd5 < 0 && yd5 < 0)
				t = 3.1415926 - acos(-yd5 / sqrt(zd5 * zd5 + yd5 * yd5));
			if (zd5 > 0 && yd5 > 0)
				t = acos(yd5 / sqrt(zd5 * zd5 + yd5 * yd5));
			if (zd5 > 0 && yd5 < 0)
				t = acos(-yd5 / sqrt(zd5 * zd5 + yd5 * yd5)) - 3.1415926;
		} else {

			/* A, D are not on the same side of B-C bonds, so the initial 
			   degree is 3.1415926 or -3.1415926 */
...
*/
	...
	xc5 = xc4;
	if (xc5 > 0) {
		xd5 = xc5 + bond * cos(3.1415926 - angle);
		if (ya5 > 0)
			yd5 = bond * sin(3.1415926 - angle);
		else
			yd5 = -bond * sin(3.1415926 - angle);
	} else {
		xd5 = xc5 - bond * cos(3.1415926 - angle);
			  ...
			  double *ww2, double *ww3)
{
	...
	if (xa5 * xc5 >= 0) {
		...
		if (xa5 >= 0) {
			w4 = 3.1415926 - acos(xa5 / sqrt(ya5 * ya5 + xa5 * xa5));
		} else
			w4 = -3.1415926 + acos(-xa5 / sqrt(ya5 * ya5 + xa5 * xa5));
	}
	*ww1 = w1;
...
double distance0(ATOM obj1, ATOM obj2, double *ww1, double *ww2)
{
	...
	if (ya == 0)
		...
		w1 = -acos(-xa / sqrt(xa * xa + ya * ya)) + 3.1415926;
	else if (xa <= 0 && ya <= 0)
		w1 = acos(-xa / sqrt(xa * xa + ya * ya)) - 3.1415926;
	else if (xa >= 0 && ya <= 0)
		w1 = -acos(xa / sqrt(xa * xa + ya * ya));
	...
	if (za3 >= 0 && xa3 >= 0)
		...
		w2 = -acos(-xa3 / sqrt(xa3 * xa3 + za3 * za3)) + 3.1415926;
	else if (za3 >= 0 && xa3 <= 0)
		w2 = acos(-xa3 / sqrt(xa3 * xa3 + za3 * za3)) - 3.1415926;
	xa4 = -za3 * sin(w2) + xa3 * cos(w2);
	/*
...
void intercoord(int atomnum, ATOM atom[])
{
	...
	select = (int *) malloc(sizeof(int) * (atomnum + 10));
        if (select == NULL) {
                fprintf(stderr, "memory allocation error for *index in intercoord()\n");
                exit(0);
        }
...
*/
        ...
        if (y == 0)
                ...
                *w1 = -acos(-x / sqrt(x * x + y * y)) + 3.1415926;
        else if (x <= 0 && y <= 0)
                *w1 = acos(-x / sqrt(x * x + y * y)) - 3.1415926;
        else if (x >= 0 && y <= 0)
                *w1 = -acos(x / sqrt(x * x + y * y));
...
*/
        ...
        if (z2 >= 0 && x2 >= 0)
                ...
                *w2 = -acos(-x2 / sqrt(x2 * x2 + z2 * z2)) + 3.1415926;
        else if (z2 >= 0 && x2 <= 0)
                *w2 = acos(-x2 / sqrt(x2 * x2 + z2 * z2)) - 3.1415926;
