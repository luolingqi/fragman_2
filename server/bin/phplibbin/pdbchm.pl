...
print OSCRIPT "write psf card unit 1\n";
...
print OSCRIPT "coor init sele type H* end\n";
print OSCRIPT "hbuild sele type H* end\n";
print OSCRIPT "\n";
...
print OSCRIPT "CONS HARM SELE .not. testc  END - \n";
print OSCRIPT "     FORCE 20 MASS END\n";
print OSCRIPT "\n";
