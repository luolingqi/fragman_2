...
/* <-- RAL 25 May 1997 */
#define MAXCON       100  /* max no of bonds allowed for any 1 atom            */
#define MAXNHB_PER_ATM 401 /* to be stored in the hb_prtnr array */
#define MAXNHB_ATOMS  2500000 /* Atoms that donate and accept */
/* #ifdef __MSDOS__
#define MAXNATM 60000  num atoms in atom[] 
#define MAXNRES 20000  num residues in ?[] 
#define MAXBRKS  5000  num chain breaks in 
#define MAXNRES_DOMAIN 0  num residues in k
#else */
#define MAXNATM 60000
#define MAXNRES 20000
